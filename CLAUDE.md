...
| Item | Status |
|---|---|
| Active feature | None in flight — three driver-app fixes pushed direct to `main` (`e41c976`, 2026-06-02). Next AVA work → new `feature/ava-phase2-sN` branch |
| Latest merge | Home/checklist fixes → `main` (`e41c976`, 2026-06-02, direct). Prior feature merge: AVA Phase 2 Session 2 (`02abfc6`, 2026-05-31) |
| Latest migrations | 021 `dependency_map_tent_tools` + 020 `sop_entries_rls` + 019 `sop_entries`; local = 21 files |
| Branch strategy | Feature work → named branch; unrelated fixes → direct to `main` |
| Next priority | See `tasks/todo.md` (top of file) — smoke-test the three 2026-06-02 fixes; then Session 2 production smoke test |
