...
| Item | Status |
|---|---|
| Active feature | None in flight — **Warehouse notes surfacing** (route- + stop-level) pushed direct to `main` (`de05529`, 2026-06-03). Prior: AVA Phase 2 **Session 3** (SOPs in `/api/ava/ask` + role scoping, `48d5487`, 2026-06-02). Next AVA work → new `feature/ava-phase2-sN` branch |
| Latest merge | Direct to `main`: warehouse notes surfacing — `routes.warehouse_notes` fetch + Home WH pill + route-start FROM WAREHOUSE sheet (read aloud) + brief awareness line + stop-note reorder (`de05529`, 2026-06-03). Prior: AVA SOP knowledge + role scoping (`48d5487`); SOP driver-visibility regex fix (`1a1d714`/`64356dd`), all 2026-06-02 |
