# PartyTime Driver App — Stack, Paths, Architecture

Where things live. The lean root `CLAUDE.md` points here whenever Claude Code needs paths, tokens, formulas, or per-feature architecture details.

---

## Repos

- **This repo:** `partytime-driver-app` at `~/Projects/partytime-driver-app`
...
## NEXT — pending smoke tests + cleanup
